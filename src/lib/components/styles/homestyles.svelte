...
.form-control:focus {
  ...
  border-color: #d4868c;
  outline: 0;
  box-shadow: 0 0 0 0.2rem rgba(161, 57, 65, 0.25);
}
...
.btn-primary:focus, .btn-primary.focus {
  ...
  background-color: #852f36;
  border-color: #7b2c32;
  box-shadow: 0 0 0 0.2rem rgba(175, 87, 94, 0.5);
}
...
.btn-secondary:focus, .btn-secondary.focus {
  ...
  background-color: #daa61a;
  border-color: #cf9d18;
  box-shadow: 0 0 0 0.2rem rgba(201, 160, 50, 0.5);
}
...
.btn-outline-primary:focus, .btn-outline-primary.focus {
  box-shadow: 0 0 0 0.2rem rgba(161, 57, 65, 0.5);
}
...
.btn-outline-secondary:focus, .btn-outline-secondary.focus {
  box-shadow: 0 0 0 0.2rem rgba(231, 182, 51, 0.5);
}
...
.custom-checkbox .custom-control-input:disabled:checked ~ .custom-control-label::before {
  background-color: rgba(161, 57, 65, 0.5);
}
...
.custom-range:focus::-webkit-slider-thumb {
  box-shadow: 0 0 0 1px #fff, 0 0 0 0.2rem rgba(161, 57, 65, 0.25);
}
...
button.bg-primary:focus {
  background-color: #7b2c32 !important;
}
...
a.text-primary:hover, a.text-primary:focus {
  color: #69252a !important;
}

.text-secondary {
  color: #e7b633 !important;
}

a.text-secondary:hover, a.text-secondary:focus {
  color: #b88c16 !important;
}
...
.portfolio .portfolio-item .portfolio-item-caption {
  ...
  opacity: 0;
  background-color: rgba(161, 57, 65, 0.9);
}
